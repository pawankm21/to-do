            ...
            {expand ? <div
                ...
                <div onClick={(e) => e.stopPropagation()} className="px-9 absolute bottom-0 z-20 right-0 w-1/2  h-full  bg-white shadow-xl pointer-events-none">
                    <textarea rows="1" onChange={(e) => {
                        resizeInput(e);
                    }} ref={titleRef} className="pointer-events-auto resize-none text-lg font-medium my-[18px] overflow-hidden outline-none w-full " defaultValue={note.title} placeholder="Give your task a title" />
                    ...
                    <div className="mt-16 ">
                        ...
                        <div className="w-full flex gap-10">
                            ...
                            <textarea rows="1" onChange={(e) => {
                                resizeInput(e);
                            }} ref={desRef} className="resize-none pointer-events-auto overflow-hidden outline-none w-full " defaultValue={note.description} placeholder="Description..." />
                        </div>
                    </div>
                </div>
